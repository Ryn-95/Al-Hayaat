      ...
      <section className="w-full bg-[#F5F0E8] py-20 md:py-28">
        <div className="w-full max-w-[1280px] mx-auto px-8 md:px-12"><div className="max-w-[780px]">
          ...
          <div className="p-6 bg-[#0D1208] rounded-[12px] text-white mt-10">
            ...
            <p className="text-[14px] font-light text-white/60 mb-4">Pour l&apos;organisation complète des obsèques musulmanes — <Link href="/toilette-rituelle-musulmane" className="text-[#6BAA6B] hover:underline">toilette rituelle</Link>, <Link href="/salat-al-janaza" className="text-[#6BAA6B] hover:underline">Salat al-Janaza</Link>, <Link href="/inhumation-carre-musulman" className="text-[#6BAA6B] hover:underline">inhumation</Link> — contactez Al Hayat. Disponible 24h/24 en <Link href="/normandie" className="text-[#6BAA6B] hover:underline">Normandie</Link> et à <Link href="/ile-de-france" className="text-[#6BAA6B] hover:underline">Paris</Link>.</p>
