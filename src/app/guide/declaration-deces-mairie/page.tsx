...
export const metadata: Metadata = { title: "Déclaration de Décès en Mairie : Guide Complet", description: "Comment déclarer un décès en mairie ? Délais, documents.", keywords: ["déclaration décès mairie","déclarer décès mairie délai"] };

export default function Page() {
  return (
    <div className="bg-[#F5F0E8] text-[#1A1A1A] min-h-screen font-inter">
      <SchemaOrg data={buildArticleSchema({ headline: "Déclaration de Décès en Mairie : Guide Complet", datePublished: "2024-06-15" })} />
      <section className="relative w-full pt-28 pb-16 bg-[#0D1208] text-white">
        <div className="relative z-10 w-full max-w-[1280px] mx-auto px-8 md:px-12">
          <Breadcrumbs items={[{ label: "Guide", href: "/guide" }, { label: "Déclaration de Décès en Mairie", href: "/guide/declaration-deces-mairie" }]} />
          <h1 className="text-[2.2rem] md:text-[3rem] font-semibold leading-[1.1] tracking-[-0.02em] text-white mb-6 mt-6 max-w-[700px]">Déclaration de Décès en Mairie : Guide Complet</h1>
          <p className="text-[15px] font-light leading-[1.7] text-white/60 max-w-[520px]">Comment déclarer un décès en mairie ? Délais, documents.</p>
        </div>
      </section>
