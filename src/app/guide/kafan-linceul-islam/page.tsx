...
export const metadata: Metadata = { title: "Le Kafan (Linceul) en Islam : Règles, Mise en Place et Signification", description: "Tout savoir sur le kafan : le linceul blanc islamique. Règles, différences homme/femme, mise en place.", keywords: ["kafan islam", "linceul musulman", "linceul blanc islam", "kafan mort islam", "mise en linceul islamique"] };
