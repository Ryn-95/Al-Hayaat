...
export const metadata: Metadata = { title: "Assurance Rapatriement de Corps : Comparatif", description: "Comparatif des meilleures assurances rapatriement.", keywords: ["assurance rapatriement corps comparatif","meilleure assurance rapatriement"] };
