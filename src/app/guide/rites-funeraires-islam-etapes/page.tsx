...
export const metadata: Metadata = { title: "Les Rites Funéraires Islamiques : De la Mort à l'Inhumation", description: "Toutes les étapes des funérailles musulmanes : annonce du décès, toilette rituelle, linceul, prière Janaza, inhumation.", keywords: ["rites funéraires islamiques", "rites funéraires musulmans", "funérailles islamiques étapes", "obsèques islamiques tradition"] };
