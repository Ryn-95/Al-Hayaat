...
export const metadata: Metadata = { title: "Certificat de Décès : Démarches et Obtention", description: "Comment obtenir un certificat de décès en France ?", keywords: ["certificat de décès","obtenir certificat décès"] };

export default function Page() {
  return (
    <div className="bg-[#F5F0E8] text-[#1A1A1A] min-h-screen font-inter">
      <SchemaOrg data={buildArticleSchema({ headline: "Certificat de Décès : Démarches et Obtention", datePublished: "2024-06-15" })} />
      <section className="relative w-full pt-28 pb-16 bg-[#0D1208] text-white">
        <div className="relative z-10 w-full max-w-[1280px] mx-auto px-8 md:px-12">
          <Breadcrumbs items={[{ label: "Guide", href: "/guide" }, { label: "Certificat de Décès", href: "/guide/certificat-deces-demarches" }]} />
          <h1 className="text-[2.2rem] md:text-[3rem] font-semibold leading-[1.1] tracking-[-0.02em] text-white mb-6 mt-6 max-w-[700px]">Certificat de Décès : Démarches et Obtention</h1>
          <p className="text-[15px] font-light leading-[1.7] text-white/60 max-w-[520px]">Comment obtenir un certificat de décès en France ?</p>
        </div>
      </section>
