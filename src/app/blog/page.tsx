...
export const metadata: Metadata = {
  ...
  description:
    "Ressources, guides et articles pour accompagner les familles musulmanes : obsèques islamiques, rapatriement, ghusl, carrés musulmans, démarches administratives.",
};
