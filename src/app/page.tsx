          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 border-t border-[#E5E5E5] pt-12 md:pt-16">
            ...
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-40px" }} className="flex flex-col">
              ...
              <ul className="flex flex-col gap-4">
                ...
                <li><Link href="/pompes-funebres-musulmanes-93-saint-denis" className="group flex items-center justify-between py-2 border-b border-[#E5E5E5] text-[14px] text-[#555] hover:text-[#111] transition-colors"><span className="group-hover:translate-x-1 transition-transform">Pompes funèbres Saint-Denis</span> <span>→</span></Link></li>
                <li><Link href="/pompes-funebres-musulmanes-95-argenteuil" className="group flex items-center justify-between py-2 border-b border-[#E5E5E5] text-[14px] text-[#555] hover:text-[#111] transition-colors"><span className="group-hover:translate-x-1 transition-transform">Pompes funèbres Argenteuil</span> <span>→</span></Link></li>
                <li><Link href="/paris-ile-de-france" className="group flex items-center justify-between py-2 border-b border-[#E5E5E5] text-[14px] text-[#555] hover:text-[#111] transition-colors"><span className="group-hover:translate-x-1 transition-transform">Toute l'Île-de-France</span> <span>→</span></Link></li>
              </ul>
            </motion.div>
          </div>
